            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-semibold text-xl text-slate-800 leading-tight">
                        Nuevo Anuncio o Licitación
                    </h2>
                </div>
            }
        >
            <Head title="Crear Nuevo Anuncio - Admin" />
                    ...
                    <form onSubmit={submit} className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="w-full lg:w-2/3 space-y-8">
                            ...
                            <Card className="p-6 border-slate-200 shadow-sm rounded-2xl border-dashed border-2 bg-slate-50 hover:bg-slate-100/50 transition-colors">
                                <div className="space-y-4">
                                        ...
                                        <div className="mt-4 space-y-2">
                                            {data.documents.map((file, idx) => (
                                                <div key={idx} className="flex items-center justify-between p-3 bg-white border border-slate-200 rounded-lg shadow-sm">
                                                    ...
                                                    <Button type="button" variant="ghost" size="sm" onClick={() => removeDocument(idx)} className="text-red-500 hover:bg-red-50 shrink-0">
                                                        <Trash2 size={16} />
                                                    </Button>
                                                </div>
                                            ))}
                                    ...
                                    {/* Using indexing access for dynamic document error keys if needed, 
                                        but typically standard errors are displayed globally here */}
                        ...
                        <div className="w-full lg:w-1/3 space-y-6">
                            ...
                            <div className="sticky top-24 pt-4">
                                ...
                                >
                                    <Save size={20} />
                                    {processing ? 'Publicando...' : 'Guardar Anuncio'}
                                </Button>
                            </div>
