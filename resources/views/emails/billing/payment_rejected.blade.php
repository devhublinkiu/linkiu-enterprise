...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Aviso sobre su Pago</h1>
        </div>
        
        <div class="content">
            <p>Hola,</p>
            <p>Le informamos que tras revisar su solicitud de pago para el plan <strong>{{ $paymentRequest->plan->name }}</strong> en <strong>CAMEP</strong>, hemos detectado un inconveniente que impide su aprobación.</p>
            
            <div class="reason-box">
                <p><strong>Motivo de la observación:</strong></p>
                <p>{{ $paymentRequest->admin_notes }}</p>
            </div>
