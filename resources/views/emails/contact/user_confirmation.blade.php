{{-- Generado por scripts/build-emails.ts desde resources/js/emails/contact/ContactUserConfirmation.tsx. NO editar a mano. --}}
                        ...
                        <tr>
                          <td>
                            <p
                              ...
                              Hola, <strong>{{ $submission->full_name }}</strong>,
                            </p>
                            <p
                              style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                              ...
                              <strong
                                >&quot;{{ $submission->service }}&quot;</strong
                              >
                              y estamos revisándola cuidadosamente.
                            </p>
                            <p
                              style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                              Nuestro equipo de CAMEP se pondrá en contacto
                              contigo lo antes posible a través de este correo
                              electrónico o el teléfono registrado.
                            </p>
                            <p
                              style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                            ...
                            <blockquote
                              style="background:#f9f9f9;padding:15px;border-left:5px solid #DD301B;font-style:italic;margin:0">
                              &quot;{{ $submission->message }}&quot;
                            </blockquote>
                          </td>
                        </tr>
