...
//   · `cn` desde '@/lib/utils'.
//   · `has-aria-expanded:` (v4) → `has-[[aria-expanded=true]]:` (v3). El resto (`data-[state=selected]`,
//     `[&:has([role=checkbox])]`, `caption-bottom`, `align-middle`) es válido en v3.
//   · Sin variantes `dark:` (regla 10). Tokens `muted`/`foreground`/`muted-foreground` (existen).
