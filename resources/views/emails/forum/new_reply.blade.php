...
<head>
    ...
    <style>
        ...
        .reply-box { background: #f1f8ff; border-left: 5px solid #17a2b8; padding: 15px; margin: 15px 0; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Nueva Respuesta en el Foro</h1>
        </div>
        
        <div class="content">
            <p>Hola,</p>
            <p><strong>{{ $reply->user->name }}</strong> ha respondido a tu debate <strong>"{{ $reply->topic->title }}"</strong>.</p>
            
            <div class="reply-box">
                <p>"{!! nl2br(e(Str::limit($reply->content, 150))) !!}"</p>
            </div>
