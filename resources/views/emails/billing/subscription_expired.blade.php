...
<head>
    ...
    <style>
        ...
        .error-box { background: #f8d7da; border: 1px solid #f5c6cb; color: #721c24; padding: 15px; border-radius: 5px; margin: 20px 0; text-align: center; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Lamentamos informarte que tu suscripción a <strong>CAMEP</strong> ha vencido oficialmente.</p>
            
            <div class="error-box">
                Tu perfil de socio ya no es visible para el público y has perdido acceso a las alertas de licitaciones.
            </div>
