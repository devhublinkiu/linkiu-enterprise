...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Empresa para Auditoría</h1>
        </div>
        
        <div class="content">
            <p>Administrador,</p>
            <p>La empresa <strong>{{ $associate->company_name }}</strong> ha completado el envío de su documentación y su perfil está listo para ser auditado.</p>
            
            <p>Por favor, ingrese al panel para revisar los datos y validar los documentos adjuntos.</p>
            
            <div style="text-align: center;">
                <a href="{{ url('/admin/associates/' . $associate->id) }}" class="btn">Revisar Empresa</a>
            </div>
        </div>
