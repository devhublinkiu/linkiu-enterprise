...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Nuevo Debate en el Foro</h1>
        </div>
        
        <div class="content">
            <p>Administrador,</p>
            <p>El usuario <strong>{{ $topic->user->name }}</strong> ha iniciado un nuevo debate en la categoría <strong>{{ $topic->category->name }}</strong>.</p>
            
            <p><strong>Título:</strong> {{ $topic->title }}</p>
