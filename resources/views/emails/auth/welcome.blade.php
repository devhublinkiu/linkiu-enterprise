...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>¡Bienvenido a CAMEP!</h1>
        </div>
        
        <div class="content">
            <p>Hola, <strong>{{ $user->name }}</strong>,</p>
            <p>Es un gusto darte la bienvenida a la plataforma de <strong>CAMEP (Cámara de Empresas del Sector Energético)</strong>.</p>
            <p>A partir de ahora, tienes acceso a un ecosistema diseñado para potenciar tu empresa en el sector energético, acceso a licitaciones exclusivas y una red de contactos estratégicos.</p>
