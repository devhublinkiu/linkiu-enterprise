...
//   · `data-horizontal:` / `data-vertical:` → `data-[orientation=horizontal]:` / `data-[orientation=vertical]:`
//     (idem con `group-data-…/tabs:`).
//   · `data-active:` (estado de Radix) → `data-[state=active]:`.
//   · `has-data-[icon=…]:` → `has-[[data-icon=…]]:`.
//   · Se quitan las variantes `dark:`. Tokens `muted`, `muted-foreground`, `foreground`,
//     `background`, `border`, `ring` (existen).
...
function Tabs({
    ...
    return (
        <TabsPrimitive.Root
            ...
            className={cn(
                // Horizontal (por defecto): lista arriba, contenido abajo.
                // Vertical: lista a la izquierda.
