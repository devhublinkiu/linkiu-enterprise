...
return [
    ...
    'attributes' => [
        ...
        'nit'                => 'NIT',
        'legal_status'       => 'naturaleza jurídica',
        'phone'              => 'teléfono',
        'department'         => 'departamento',
        'city'               => 'ciudad',
        'address'            => 'dirección',
        'rep_name'           => 'nombre del representante',
        'rep_position'       => 'cargo del representante',
        'rep_doc_type'       => 'tipo de documento del representante',
        'rep_doc'            => 'documento del representante',
        'billing_email'      => 'email de facturación',
        'main_ciiu'          => 'CIIU principal',
        'secondary_ciiu'     => 'CIIU secundario',
        'company_type'       => 'perfil de operación',
        'contacts'           => 'contactos',
        'contacts.*.name'    => 'nombre del contacto',
        'contacts.*.area'    => 'área del contacto',
        'contacts.*.position'=> 'cargo del contacto',
        'contacts.*.email'   => 'email del contacto',
        'contacts.*.phone'   => 'teléfono del contacto',
        'references'                  => 'referencias',
        'references.*.name'           => 'nombre de la referencia',
        'references.*.type'           => 'tipo de referencia',
        'references.*.email'          => 'email de la referencia',
        'references.*.contact_person' => 'contacto de la referencia',
