...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>ALERTA: Contenido Reportado en el Foro</h1>
        </div>
        
        <div class="content">
            <p>Administrador,</p>
            <p>Se ha recibido un reporte sobre un contenido en el foro de la comunidad.</p>
            
            <p><strong>Reportado por:</strong> {{ $report->user->name }}</p>
            <p><strong>Motivo:</strong> {{ $report->reason }}</p>
            
            <p>Por favor, revise el contenido y tome las medidas necesarias desde el panel de moderación.</p>
        </div>
