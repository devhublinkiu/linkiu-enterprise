...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hola,</p>
            <p>Nos complace informarle que su pago ha sido verificado y aprobado con éxito en <strong>CAMEP</strong>.</p>
            
            <div class="plan-box">
                <p><strong>Plan Activado:</strong> {{ $paymentRequest->plan->name }}</p>
                <p><strong>Monto:</strong> ${{ number_format($paymentRequest->amount, 2) }}</p>
