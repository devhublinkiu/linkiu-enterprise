{{--
    Envoltorio compartido para los correos de facturación nuevos.
    Reproduce el diseño de las plantillas existentes sin volver a copiar
    la cabecera, los estilos y el pie en cada archivo.

    Uso:
        @extends('emails._layout', ['title' => 'Pago registrado'])
...
<head>
    ...
    <style>
        ...
        .plan-box { background: #f0fff4; border: 1px solid #c6f6d5; padding: 15px; border-radius: 5px; margin: 15px 0; }
        .warn-box { background: #fffaf0; border: 1px solid #feebc8; padding: 15px; border-radius: 5px; margin: 15px 0; }
        .alert-box { background: #fff5f5; border: 1px solid #fed7d7; padding: 15px; border-radius: 5px; margin: 15px 0; }
        .data-row { margin: 4px 0; }
        .data-row strong { color: #151515; }
    </style>
</head>
<body>
    <div class="container">
