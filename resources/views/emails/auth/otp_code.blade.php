{{-- Generado por scripts/build-emails.ts desde resources/js/emails/auth/OtpCode.tsx. NO editar a mano. --}}
...
@if ($purpose === 'password_reset')
                            ...
                            <p
                              ...
                              contraseña de tu cuenta en <strong>CAMEP</strong>.
...
@if ($purpose !== 'password_reset')
                            ...
                            <p
                              style="font-size:14px;line-height:24px;margin-top:16px;margin-bottom:16px">
                              Gracias por registrarte en <strong>CAMEP</strong>.
...
@endif
                            ...
                            <table
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <span
                                      style="display:inline-block;font-size:34px;font-weight:bold;letter-spacing:10px;color:#151515;background:#f7f7f7;border:1px solid #eee;border-radius:10px;padding:16px 24px"
                                      >{{ $code }}</span
                                    >
                                  </td>
                                </tr>
                            ...
                            <p
                              style="font-size:13px;line-height:24px;color:#888;margin-top:16px;margin-bottom:16px">
                              Si no solicitaste esto, puedes ignorar este
                              mensaje; tu cuenta sigue segura.
                            </p>
                          </td>
                        </tr>
                      </tbody>
