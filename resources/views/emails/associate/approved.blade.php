...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>¡Perfil Verificado con Éxito!</h1>
        </div>
        
        <div class="content">
            <p>Estimado equipo de <strong>{{ $associate->company_name }}</strong>,</p>
            <p>¡Excelentes noticias! El proceso de auditoría de su empresa en <strong>CAMEP</strong> ha finalizado satisfactoriamente y su perfil ha sido verificado.</p>
