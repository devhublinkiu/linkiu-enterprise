...
<head>
    ...
    <style>
        ...
        .alert-box { background: #fff3cd; border: 1px solid #ffeeba; color: #856404; padding: 15px; border-radius: 5px; margin: 20px 0; text-align: center; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Aviso de Vencimiento de Suscripción</h1>
        </div>
        
        <div class="content">
            <p>Hola, <strong>{{ $associate->name ?? 'Socio' }}</strong>,</p>
            <p>Te informamos que tu suscripción a los servicios de <strong>CAMEP</strong> está próxima a vencer.</p>
            
            <div class="alert-box">
                Restan aproximadamente <strong>{{ $daysRemaining }} días</strong> de vigencia.
            </div>
